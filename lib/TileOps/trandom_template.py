...
"""TileLang DSL template for pto.trandom - expanded inline without multi-return inline_proc"""
...
def _check_rounds_10(rounds) -> bool:
    return rounds == "10"


def _check_rounds_7(rounds) -> bool:
    return rounds == "7"
...
@pto.vkernel(
    ...
    constraints=[_check_rounds_7, _check_row_major],
    advanced=True,
)
def template_trandom_rounds7(
    key0: pto.i32,
    key1: pto.i32,
    counter0: pto.i32,
    counter1: pto.i32,
