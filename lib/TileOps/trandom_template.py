...
"""TileLang DSL template for pto.trandom - unified template using loop-based rounds"""
...
def template_trandom(
    ...
    rounds_imm = pto.get_op_attr("rounds", 10)
    if pto.constexpr(rounds_imm == 10):
        rounds_count = 10
    elif pto.constexpr(rounds_imm == 7):
        rounds_count = 7
    else:
        rounds_count = 10
    ...
    for i in range(0, valid_rows, 1):
        ...
        for j in range(0, n_loop, 1):
            ...
            for _ in range(0, rounds_count, 1):
